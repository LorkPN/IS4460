...
class ContactEdit(View):
    def get(self, request, contact_id=None):
        ...
        return render(request = request,
                      ...
                      context = {'contact':contact,'form':form, 'message' : 'Contact created successfully.'})
...
class ContactList(View):
    ...
    def get(self,request):
        ...
        return render(request = request,template_name = 'customer_app/contact_list.html',context = {'contacts':contacts})